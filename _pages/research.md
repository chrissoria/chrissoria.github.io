...
**What frontier access buys.** [What Does Frontier Access Buy?](https://osf.io/preprints/socarxiv/5g34x_v1) benchmarks eighteen LLMs across four access tiers — proprietary flagships down to open-weight models that run on a laptop — against human consensus on five survey-coding tasks in three contexts. The flagship tier's average margin over cheaper commercial models is statistically indistinguishable from zero despite 1.3–6× higher per-token prices, and the largest open-weight models match both proprietary tiers on cell-level agreement (under review at *Survey Research Methods*).
